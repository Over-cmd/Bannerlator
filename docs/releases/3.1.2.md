...
&nbsp;<img src="https://img.shields.io/badge/Wayland-experimental-f59e0b?style=for-the-badge" alt="Wayland experimental" />
</p>
...
<!-- update-summary: Wayland arrives as an experimental second display backend, off by default and chosen per container. It needs one of the new versionCode 8 arm64ec Proton 11 layers. It is very new, it has bugs, and it is not a replacement for X11 - X11 stays the default and stays supported. Also: new v8 compatibility layers, and a physical controller stick can now move the mouse. -->
