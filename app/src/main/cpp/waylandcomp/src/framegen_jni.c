...
Java_com_winlator_star_wayland_WaylandCompositor_nativeSetFrameGenEngine(JNIEnv *env, jclass clazz, jint kind) {
    (void)env; (void)clazz;
    vkp_framegen_set_engine((int)kind);
}

JNIEXPORT void JNICALL
Java_com_winlator_star_wayland_WaylandCompositor_nativeSetFrameGenArmed(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_winlator_star_wayland_WaylandCompositor_nativeSetLsfgCachePath(JNIEnv *env, jclass clazz, jstring path) {
    (void)clazz;
...
JNIEXPORT void JNICALL
Java_com_winlator_star_wayland_WaylandCompositor_nativeSetFrameGenTuning(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_winlator_star_wayland_WaylandCompositor_nativeSetWinFgTuning(JNIEnv *env, jclass clazz,
...
Java_com_winlator_star_wayland_WaylandCompositor_nativeFrameGenProblem(JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
    return (jint)vkp_framegen_problem();
}

JNIEXPORT jstring JNICALL
Java_com_winlator_star_wayland_WaylandCompositor_nativeFrameGenCapsReason(JNIEnv *env, jclass clazz) {
    (void)clazz;
...
Java_com_winlator_star_wayland_WaylandCompositor_nativeFrameGenStats(JNIEnv *env, jclass clazz) {
    (void)clazz;
